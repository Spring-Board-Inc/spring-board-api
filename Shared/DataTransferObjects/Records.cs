namespace Shared.DataTransferObjects
{
    ...
    public record EducationToReturnDto(Guid Id, string School, string Course, string LevelOfEducation, DateTime StartDate, DateTime EndDate, string City, DateTime CreatedAt, DateTime UpdatedAt);
    ...
    public record JobToReturnDto(Guid Id, string Title, string Description, string SalaryRange, DateTime? ClosingDate, DateTime CreatedAt, DateTime UpdatedAt);
}